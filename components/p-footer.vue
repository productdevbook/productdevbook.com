    ...
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      >
        <div
          ...
          :key="item.name"
          :class="item.href !== '#' ? '' : 'opacity-50'"
          class="px-5 py-2"
        >
          <nuxt-link :href="item.href" class="text-base">
            {{ item.name }}
          </nuxt-link>
        </div>
      </nav>
      <div class="mt-8 flex justify-center space-x-6">
        <a
          ...
          :key="item.name"
          :href="item.href"
          class="text-gray-400 hover:text-zinc-50"
        >
      ...
      <p class="mt-8 text-center text-base">
        productdevbook.com -
        <NuxtLink to="https://github.com/productdevbook/productdevbook.com">
